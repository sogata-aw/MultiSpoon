...
class VoiceChannelCogs(commands.GroupCog, group_name="vocal"):
    ...
    async def ajouter(self, interaction : discord.Interaction, salon : discord.VoiceChannel):
        self.bot.settings["guilds"][interaction.guild.name]["channelToCheck"].append(salon.id)
    ...
    async def supprimer(self, interaction : discord.Interaction, salon : discord.VoiceChannel):
        if salon.id in self.bot.settings["guilds"][interaction.guild.name]["channelToCheck"]:
            self.bot.settings["guilds"][interaction.guild.name]["channelToCheck"].remove(salon.id)
    ...
    async def afficher(self, interaction : discord.Interaction):
        ...
        for vocal in self.bot.settings["guilds"][interaction.guild.name]["channelToCheck"] :
